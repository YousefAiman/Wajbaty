...
//            startActivityIfNeeded(intent, REQUEST_IMAGE_CAPTURE);
            ...
            final CharSequence[] options = {getResources().getString(R.string.take_photo),
                    getResources().getString(R.string.choose_from_gallery), getResources().getString(R.string.cancel)};

            AlertDialog.Builder builder = new AlertDialog.Builder(AddImageProfileActivity.this);
            builder.setTitle(getResources().getString(R.string.add_photo));
            builder.setItems(options, (dialog, which) -> {
                if (options[which].equals(getResources().getString(R.string.take_photo))) {
                    getCamera();
                } else if (options[which].equals(getResources().getString(R.string.choose_from_gallery))) {
